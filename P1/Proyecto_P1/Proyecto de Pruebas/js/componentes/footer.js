            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <h5 style: "color: #dcdcdc !important;">Sobre Nosotros</h5>
                        <p style: "color: #dcdcdc !important;">AG-Store es tu tienda de confianza para encontrar los mejores productos tecnológicos al mejor precio.</p>
                        <div style: "color: #dcdcdc !important;">
                    ...
                    <div class="col-lg-4" style: "color: #dcdcdc !important;">
                        <h5>Contacto</h5>
                        <ul class="list-unstyled">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <small style: "color: #dcdcdc !important;">&copy; ${new Date().getFullYear()} AlexGames Studios. Todos los derechos reservados.</small>
                    </div>
